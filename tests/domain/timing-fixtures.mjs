...
const DEFINITIONS=[
  ...
  ['T16-refinance-close','Refinance-close at terminal year','BASELINE_ONLY',o=>{set(o,'strategy.exitStrategy','إعادة تمويل (Hold/Refinance)');set(o,'strategy.salePct',0);set(o,'development.operationYears',5);set(o,'income.rent',800);set(o,'income.occupancy',0.9);set(o,'income.opex',0.2);set(o,'income.refinance.refiLtv',0.65);set(o,'income.refinance.refiCostPct',0.01);} ],
  ['T17-perpetual-hold-periodic-refi','Perpetual hold with periodic refinance','BASELINE_ONLY',o=>{set(o,'meta.oppType','income');set(o,'income.holdStrategy','perpetual_hold');set(o,'income.rent',800);set(o,'income.occupancy',0.9);set(o,'income.opex',0.2);set(o,'income.refinance.intervalYears',3);set(o,'income.refinance.refiLtv',0.65);set(o,'income.refinance.refiCostPct',0.01);set(o,'income.refinance.analysisHorizon',8);set(o,'development.constructionYears',1);set(o,'development.operationYears',5);} ],
